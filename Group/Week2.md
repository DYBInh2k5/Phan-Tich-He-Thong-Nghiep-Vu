...
Your team will review and refine the simulated enterprise created in Week 1.

### Instructions

1. Review your team's  **Enterprise Profile** .
2. Discuss and revise any unclear or inconsistent information.
3. Complete the checklist below.
4. Identify each member's **Primary Investigation Focus** and  **Primary Stakeholder** .
5. Submit **one response per group** on Moodle.

### Group Checklist

Copy the checklist below into the **Online Text submission** and complete it together.

**Enterprise Context**

☐ Business type is clear
☐ Main products/services are clear
☐ Main customers are clear
☐ Sales/delivery channels are clear
☐ Locations are clear

**Business Functions**

☐ Sales & Marketing is identified
☐ Product/Service Operations is identified
☐ Accounting & Finance is identified
☐ HR & Administration is considered
☐ Other necessary functions are identified

**Organization & Investigation**

☐ Key roles/stakeholders are identified
☐ Relationships between business functions are understandable
☐ Each student has a clear Primary Investigation Focus
☐ Each student has a relevant Primary Stakeholder
☐ No technology solution has been proposed prematurely
...
| Student | Primary Investigation Focus | Primary Stakeholder |
| ------- | --------------------------- | ------------------- |
|         |                             |                     |
|         |                             |                     |
|         |                             |                     |
...
* All group members should participate in the discussion and review.
...
* **Team Leader / Representative**: Vo Duy Binh (Student ID: 22301500)
...
* **Core Product Catalog (10 Domain SKUs)**:
  1. `ST-001`: A4 Copy Paper Double A 70gsm (Ream)
  2. `ST-002`: A4 Copy Paper IK Plus 80gsm (Ream)
  3. `ST-003`: Thien Long TL-027 Blue Ballpoint Pen (Box of 20)
  4. `ST-004`: Pilot G2 Black Gel Pen 0.7mm (Box of 12)
  5. `ST-005`: King Jim A4 Display Book 60 Pockets (Piece)
  6. `ST-006`: Deli A5 Spiral Notebook 160 Pages (Piece)
  7. `ST-007`: Kangaro HD-10 Heavy Duty Stapler (Piece)
  8. `ST-008`: Kangaro No.10 Staples (Big Box of 20 small packs)
  9. `ST-009`: Original HP 107a Black Laser Toner Cartridge (Box)
...
4. **Invoicing & Accounts Receivable**: Verifies 3-way matching (SO + Delivery Note + Invoice), issues official VAT invoices, enforces Net 30 payment terms, and manages credit hold policies.
...
## 3. CONTEXT REFINEMENT & RESOLVED INCONSISTENCIES

During the Week 2 group review session, Group 6 discussed and resolved the following operational inconsistencies from the Week 1 initial context draft:
...
3. **Credit Hold Policy vs. Operational Reality**:
   * *Initial Draft*: Credit hold for clients with nợ quá hạn > 30 ngày was assumed to be strictly enforced.
   * *Refinement*: A paper policy exists, but Sales reps frequently bypass it by making informal verbal appeals to management, leading to tension between Sales and Accounting. This bottleneck will be investigated during stakeholder interviews.
